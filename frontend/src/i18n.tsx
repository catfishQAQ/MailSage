...
const dictionaries = {
  'zh-CN': {
    ...
    aiConsolePendingAccount: '当前账号待处理：{count}',
    aiConsolePendingGlobal: '全局待处理：{count}',
    aiConsolePendingInline: '当前邮箱：{account}，所有邮箱：{global}',
    aiConsoleTrigger: '处理未读邮件',
  ...
  'en-US': {
    ...
    aiConsolePendingAccount: 'Current account pending: {count}',
    aiConsolePendingGlobal: 'Global pending: {count}',
    aiConsolePendingInline: 'Current mailbox: {account}, all mailboxes: {global}',
